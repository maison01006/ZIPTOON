...
<form action="login.do" method="post">
		...
		<h4 style="text-align: center"><span class="font-weight-bolder">로그인</span></h4>
		
		<div style="width: 260px;margin: auto;">
			<div class="input-groupcontainer" style="margin-top: 5%;">

  			<input id="id" type="text" class="form-control" name="id" style="min-width: 100px;" placeholder="id">
		</div>
	...
	<div>
		<button class="col btn btn-dark" type="submit" >로그인</button>
	</div>
	<div>
		<a>아이디/비밀번호 찾기</a>
...
<div class="col" style="text-align: center;border-right: 1px solid #dddddd;margin-top:5px;background-color: white;">
  ...
  <path d="M7 6.5C7 7.328 6.552 8 6 8s-1-.672-1-1.5S5.448 5 6 5s1 .672 1 1.5zm4 0c0 .828-.448 1.5-1 1.5s-1-.672-1-1.5S9.448 5 10 5s1 .672 1 1.5z"/>
	...
	<c:choose>
      	<c:when test="${empty userId}">
      		<a href="login" onclick="activeSetting()">
      	</c:when>
      	<c:otherwise>
