...
<div class="container" style="text-align: center;">
	...
	<div class="row justify-content-center">
		<div class="col-3">
			작성일자 : <c:out value="${data.date }"></c:out>
		</div>
		<div class="col-3">
			작성자 : <c:out value="${data.userId }"></c:out>
		</div>
		<div class="col-3">
			문의유형 : <c:out value="${data.type }"></c:out>
		</div>
		<div class="col-3">
			답변여부 : <c:out value="${data.result }"></c:out>
		</div>
	</div>
	<div class="row justify-content-center" style="border:solid #dddddd;border-bottom: 0px; margin: 0px;position: relative;">
		<div style="left:0px;position:absolute;border-right: 3px solid #dddddd; width: 70px;">
			제목
		</div>
		<div>
	...
	<div style="border:3px solid #dddddd;min-height: 400px;">
		<c:out value="${data.text }"></c:out>
	</div>
	<c:if test="${data.result eq 'y'}">
		<div>
			${result }
		</div>
	</c:if>
